...
export interface ISwaggerPathResponse {
    ...
    type?: string;
    headers?: {
        [key: string]: ISwaggerPathResponseHeader;
    };
...
export interface ISwaggerPath {
    ...
    responses: {
        [key: string]: ISwaggerPathResponse;
    };
    security?: {
        [key: string]: string[];
    };
...
export interface ISwaggerDefinitions {
    ...
    required?: string[];
    properties: {
        [key: string]: ISwaggerDefinitionsProperty;
    };
    xml?: ISwaggerDefinitionsXml;
}
...
export interface ISwagger {
    ...
    securityDefinitions: {
        [key: string]: (ISwaggerSecurityDefinitionsAuth | ISwaggerSecurityDefinitionsApiKey);
    };
    definitions: {
        [key: string]: ISwaggerDefinitions;
    };
